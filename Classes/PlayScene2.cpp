...
bool PlayScene2::init()
{
	...
	back = Sprite::create("ambition.jpg");
	...
	auto label = Label::createWithTTF("Dream..", "fonts/bemin.ttf", 25);
	...
	Singleton_data::getInstance()->Stage = 2;
	...
	tKeyListener->onKeyPressed = CC_CALLBACK_2(PlayScene2::onKeyPressed, this);
	tKeyListener->onKeyReleased = CC_CALLBACK_2(PlayScene2::onKeyReleased, this);
	...
	mpListener->onTouchBegan = CC_CALLBACK_2(PlayScene2::onTouchBegan, this);
	_eventDispatcher->addEventListenerWithSceneGraphPriority(mpListener, this);


	multiListener = EventListenerTouchAllAtOnce::create();
	multiListener->onTouchesBegan = CC_CALLBACK_2(PlayScene2::onTouchesBegan, this);
	...
	this->schedule(schedule_selector(PlayScene2::OnTimer), 0.44444444);
	this->scheduleOnce(schedule_selector(PlayScene2::kicktimer), 0.88888888);
	this->scheduleOnce(schedule_selector(PlayScene2::snaretimer), 1.77777776);
	this->schedule(schedule_selector(PlayScene2::bartimer), 0.5);
	this->scheduleUpdate();
...
void PlayScene2::bartimer(float t)
{
...
void PlayScene2::onKeyPressed(cocos2d::EventKeyboard::KeyCode keycode, cocos2d::Event* event)
{
...
bool PlayScene2::onTouchBegan(cocos2d::Touch* touch, cocos2d::Event* unused_event)
{
...
void PlayScene2::onTouchesBegan(const std::vector<Touch*>& touches, Event* event)
{
...
void PlayScene2::onKeyReleased(cocos2d::EventKeyboard::KeyCode keycode, cocos2d::Event* event)
{
	if (keycode == EventKeyboard::KeyCode::KEY_LEFT_ARROW)
	{
...
void PlayScene2::kicktimer(float t)
{
	kicknote->DoAlive();
...
void PlayScene2::snaretimer(float t)
{
	snarenote->DoAlive();
...
void PlayScene2::OnTimer(float  f)
{
...
void PlayScene2::update_stat(float dt)
{
	char tempz[512];
	memset(tempz, 0, 512);
...
{
	/*this->schedule(schedule_selector(PlayScene2::OnTimer), 1);
	normal_count = 0;*/



	this->unscheduleUpdate();
	this->unschedule(schedule_selector(PlayScene2::OnTimer));
